...
const AdminUsers = () => {
  ...
  const [newRole, setNewRole] = useState<"admin" | "seo_editor">("seo_editor");
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-2">
                      ...
                      <select
                        value={u.role}
                        onChange={(e) => {
                          const value = e.target.value as "admin" | "seo_editor" | "pending";
          ...
          <div className="w-full max-w-sm bg-background border border-primary/30 rounded-xl p-6 space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-1">
                ...
                <select
                  value={newRole}
                  onChange={(e) => setNewRole(e.target.value as "admin" | "seo_editor")}
